...
select stg.[File_Name],stg.[File_Time],stg.[Source],stg.[DataDomain],stg.Entity from   
(select [File_Name],[File_Time],[Status_Flag],[Source],[DataDomain],[Entity] from [dbo].[Log_DataFeedRepository] where Status_Flag =2)stg  
left join  
